...
CREATE TABLE IF NOT EXISTS `NGO` (
  ...
  CONSTRAINT `fk_NGO_NGO_CATEGORY1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_NGO_NGO_ADDRESS1`
    FOREIGN KEY (`NGO_ADDRESS_ID`)
    REFERENCES `NGO_ADDRESS` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE INDEX `fk_NGO_NGO_ADDRESS1_idx` ON `NGO` (`NGO_ADDRESS_ID` ASC) VISIBLE;
